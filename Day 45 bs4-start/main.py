...
print(class_h3)  # <h3 class="heading">Books and Teaching</h3>
print(class_h3.getText())  # Books and Teaching
...
print(heading_s)  # [<h3 class="heading">Books and Teaching</h3>, <h3 class="heading">Other Pages</h3>]

# ** Input 태그 정보 가져오기 **
# <input> 태그 선택
input_a = soup.find("input")
print(input_a)  # <input type="text" name="q" maxlength="255" value="" />

# <input> 태그의 maxlength 속성 값 가져오기
print(input_a.get("maxlength"))  # 255
